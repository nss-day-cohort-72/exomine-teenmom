                ...
                if (singleMineral.id === mineral.mineralId) {
                    if (mineral.load > 0) {
                        ...
                        facilityMineralsArray.push(
                            `Gamy<input class='radio' data-type='mineral' name='${mineral.facilityId}' data-mineralid='${mineral.mineralId}' data-facilityid='${mineral.facilityId}' data-load='${mineral.load}' data-facilityMineralId='${mineral.id}' data-id='${singleMineral.id}' data-name=${singleMineral.name} data-facilityname='Ganymede' type='radio' id='${singleMineral.name.toLowerCase()}-${mineral.facilityId}-input'><div id='${singleMineral.name}-${mineral.facilityId}'>${mineral.load} tons of ${singleMineral.name}</div><br>`
                        )
                    }
                }
            }
        ...
        if (mineral.facilityId === 2) {
            for (const singleMineral of singleMinerals) {
                if (singleMineral.id === mineral.mineralId) {
                    if (mineral.load > 0) {
                        facilityMineralsArray.push(
                            `Enceledus<input class='radio' data-type='mineral' name='${mineral.facilityId}' data-load='${mineral.load}' data-facilityMineralId='${mineral.id}' data-id='${singleMineral.id}' data-name=${singleMineral.name} data-facilityname='Oberon' type='radio' id='${singleMineral.name.toLowerCase()}-${mineral.facilityId}-input'><div id='${singleMineral.name}-${mineral.facilityId}'>${mineral.load} tons of ${singleMineral.name}</div><br>`
                        )
                    }
                }
            }
        ...
        if (mineral.facilityId === 3) {
            for (const singleMineral of singleMinerals) {
                if (singleMineral.id === mineral.mineralId) {
                    if (mineral.load > 0) {
                        facilityMineralsArray.push(
                            `Oberon<input class='radio' data-type='mineral' name='${mineral.facilityId}' data-load='${mineral.load}' data-facilityMineralId='${mineral.id}' data-id='${singleMineral.id}' data-name=${singleMineral.name} data-facilityname='Io' type='radio' id='${singleMineral.name.toLowerCase()}-${mineral.facilityId}-input'><div id='${singleMineral.name}-${mineral.facilityId}'>${mineral.load} tons of ${singleMineral.name}</div><br>`
                        )
                    }
                }
            }
        ...
        if (mineral.facilityId === 4) {
            for (const singleMineral of singleMinerals) {
                if (singleMineral.id === mineral.mineralId) {
                    if (mineral.load > 0) {
                        facilityMineralsArray.push(
                            `Io<input class='radio' data-type='mineral' name='${mineral.facilityId}' data-load='${mineral.load}' data-facilityMineralId='${mineral.id}' data-id='${singleMineral.id}' data-name=${singleMineral.name} data-facilityname='Enceladus' type='radio' id='${singleMineral.name.toLowerCase()}-${mineral.facilityId}-input'><div id='${singleMineral.name}-${mineral.facilityId}'>${mineral.load} tons of ${singleMineral.name}</div><br>`
                        )
                    }
                }
            }
